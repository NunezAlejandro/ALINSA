...
links.forEach(link => {
    link.addEventListener('click', (e) => {
        ...
        switch (texto) {
            ...
            case 'registrar chequeo': mostrarSeccion('registrarChequeoSection'); break;
            case 'historial nutricional': mostrarSeccion('historialSection'); break;
            case 'reportes mensuales': mostrarSeccion('reportesMensualesSection'); break;
